...
export function WhatsAppButton({ 
  ...
  const whatsappUrl = getWhatsAppUrl(contactInfo.whatsapp, message);
  ...
  return (
    <a
      ...
      className={`fixed ${positionClasses[position]} bg-[#25D366] hover:bg-[#20BA5A] text-white px-5 py-3 rounded-full shadow-2xl transition-all hover:scale-105 z-50 flex items-center gap-3 group`}
